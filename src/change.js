...
if (Number.isNaN(amount)) {console.log("Invalid")    // print your error message here
  ...
  // print your error message here
    ...
    while(amount>=dime&amount<quarter){
      amount=amount-dime;
      dimenumber++;
    }
    while(amount>=nickel&amount<dime){
      amount=amount-nickel;nickelnumber++;
    }
      while(amount>=penny&amount<nickel){
        amount=amount-penny;
        pennynumber++;
  }
}
